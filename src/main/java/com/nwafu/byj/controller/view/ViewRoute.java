package com.nwafu.byj.controller.view;
...
public class ViewRoute {
	...
	@RequestMapping("/parseAccessByday")
	public String parseAccessByday(){
		return "parseAccessByday";
	}

	@RequestMapping("/parseAccessBytime")
